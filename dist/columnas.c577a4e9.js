...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"js/columnas/preloader.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/columnas/menuItem.js":[function(require,module,exports) {
"use strict";
...
// const images = Object.entries(require('../../uploads/*.png'));
//Mano propia
...
function loadCols() {
  return _loadCols.apply(this, arguments);
} // returns a promise


function _loadCols() {
  _loadCols = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var arr, cols, no_result, i, id, image, l_arr;
...
function wrapperFunc() {
  return _wrapperFunc.apply(this, arguments);
} // track the mouse position


function _wrapperFunc() {
  _wrapperFunc = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var images;
...
var MenuItem = /*#__PURE__*/function () {
  ...
  _createClass(MenuItem, [{
    ...
    value: function layout() {
      ...
      this.DOM.revealImage.className = 'hover-reveal__img'; // this.DOM.revealImage.style.backgroundImage = `url(${images[this.inMenuPosition][1]})`;

      wrapperFunc().then(function (result) {
        _this.DOM.revealImage.style.backgroundImage = "url(".concat(result[_this.inMenuPosition][1], ")"); // got final result
      }).catch(function (err) {
        // got error
    ...
    value: function initEvents() {
      ...
      this.mouseenterFn = function (ev) {
        ...
        _this2.firstRAFCycle = true; // start the render loop animation (rAF)
      ...
      this.mouseleaveFn = function () {
        ...
        _this2.stopRendering(); // hide the image element
    ...
    value: function showImage() {
      ...
      this.tl = _gsap.gsap.timeline({
        onStart: function onStart() {
          // show the image element
          _this3.DOM.reveal.style.opacity = 1; // set a high z-index value so image appears on top of other elements
    ...
    value: function hideImage() {
      ...
      this.tl = _gsap.gsap.timeline({
        ...
        onComplete: function onComplete() {
          _gsap.gsap.set(_this4.DOM.reveal, {
            opacity: 0
          });
        }
      }).to(this.DOM.revealInner, 0.2, {
...
},{"gsap":"../node_modules/gsap/index.js","../utils":"js/utils.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js"}],"js/columnas/menu.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"../node_modules/gsap/index.js","./menuItem":"js/columnas/menuItem.js"}],"js/columnas/index.js":[function(require,module,exports) {
"use strict";
...
function _wrapperFunc() {
  _wrapperFunc = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var cols;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            cols = _context2.sent;
            return _context2.abrupt("return", cols);
...
wrapperFunc().then(function (cols) {
...
},{"../cursor":"js/cursor.js","./preloader":"js/columnas/preloader.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","./menu":"js/columnas/menu.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/columnas/index.js"], null)
//# sourceMappingURL=/columnas.c577a4e9.js.map